...
export const burgerData: CartItem[] = [
    ...
    { name: 'Italiana', description: "Pechuga de pollo, queso mozarella, tomate hojas de albahaca, salsa prego, pesto, salsa ranch, papas gajo, aderezo chipotle.", basePrice: 5800, price: 5800, img: ImgItaliana, quantity: 1, available: true, category: "burger", ingreds: ["queso", "tomate", "albahaca", "pesto"], extras: extraIngredients },
    { name: 'Mexicana', description: "Torta de res, cebolla caramelizada, queso mozarella, tomate, lechuga, chile jalapeño, papas gajo, aderezo chipotle.", basePrice: 5800, price: 5800, img: ImgMexicana, quantity: 1, available: true, category: "burger", ingreds: ["cebolla", "queso", "tomate", "lechuga", "chile"], extras: extraIngredients },
    { name: 'Sweet Explosion', description: "Torta angus 1/4 de libra, cebolla caramelizada, tomate, queso mozzarella, salsa BBQ, papas gajo, aderezo chipotle.", basePrice: 5800, price: 5800, img: ImgSweet, quantity: 1, available: true, category: "burger", ingreds: ["cebolla", "tomate", "queso"], extras: extraIngredients },
    ...
    { name: 'Veggie', description: "Pan twings, torta de falafel, hongos, tomate, zucchini, aguacate, cebolla morada, salsa mostaza miel, papas gajo, aderezo chipotle.", basePrice: 6500, price: 6500, img: ImgVeggie, quantity: 1, available: true, category: "burger", ingreds: ["hongos", "tomate", "zucchini", "aguacate", "cebolla"], extras: extraIngredients },
    ...
    { name: 'Combo 4 Jinetes', description: "Elige una hamburguesa entre la New York, Chicago, Italiana o Mexicana + papas gajo y un refresco Tropical de 600ml.", basePrice: 5900, price: 5900, img: ImgComboFour, quantity: 1, available: true, category: 'combo', ingreds: [], extras: comboBurgerExtras },
...
export const promoCodeList = [ { key:"macabroso", discount:10 }, { key:"applegate", discount:10 }, { key: "masis_hil", discount: 15 }, { key: "sgheaven88", discount: 15 }, { key: "oreamuno_kenneth", discount: 15 }, { key: "davidleungaraya", discount: 15 }, { key: "eldjyohan", discount: 15 }, { key: "victorious_sa", discount: 15 }, { key: "sandy_jc7", discount: 15 }, { key: "diana_alvrz23", discount: 15 }, { key: "imchimibp", discount: 15 }, { key: "pao28cas", discount: 15 }, { key: "ale_77700", discount: 15 }, { key: "tony_picado21", discount: 15 }, { key: "andresgomezsolano", discount: 15 }, { key: "viro1088", discount: 15 }, { key: "sebastianhid", discount: 15 } ];